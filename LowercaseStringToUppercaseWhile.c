//A program that reads a lowercase string of any size and prints its uppercase equivalent for each letter. Using the "while" command to scan the string to the end.
#include <stdio.h>
#include <stdlib.h>
#include <ctype.h>
